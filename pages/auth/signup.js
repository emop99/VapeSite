      ...
      <div className="w-full max-w-md space-y-8">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="mt-6 space-y-4 border-t border-gray-200 pt-4">
            <h3 className="text-sm font-medium text-gray-700">이용약관 및 개인정보 수집 동의</h3>
            <div className="bg-gray-50 p-4 rounded-md text-sm text-gray-600 max-h-40 overflow-y-auto whitespace-pre-line">
