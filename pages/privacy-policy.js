          ...
          <div className="prose max-w-none">
            ...
            <Section title="1. 수집하는 개인정보 항목">
              ...
              <ul className="list-disc list-inside space-y-2">
                <ListItem><strong>수집항목:</strong> 로그인ID, 비밀번호, 이메일</ListItem>
            ...
            <Section title="2. 개인정보의 수집 및 이용목적">
              ...
              <ul className="list-disc list-inside space-y-2">
                <ListItem>회원 관리: 개인 식별 , 불량회원의 부정 이용 방지와 비인가 사용 방지 , 가입 의사 확인 , 불만처리 등 민원처리 , 고지사항 전달</ListItem>
              </ul>
            </Section>
            ...
            <Section title="3. 개인정보의 보유 및 이용기간">
              ...
              <ul className="list-disc list-inside space-y-2">
                <ListItem><strong>보존 항목:</strong> 로그인ID , 비밀번호 이메일</ListItem>
